        ...
        <View style={styles.container}>
          <View style={{ flex: 1 }}>
            <EDButton
              style={[
                ...
                { backgroundColor: EDColors.black, marginHorizontal: 3 },
              ]}
              label={"Laundry"}
              textStyle={{
              ...
              onPress={() =>
                NavigationService.navigateToSpecificRoute("Laundry")
              }
            />
            {/* <LaundryButton  title="laundry" url={"https://laundry.ekohotelsdelivery.com/"} /> */}
          </View>
          {/* Table reservation */}
          <View style={{ flex: 1 }}>
            <EDButton
              style={[{ backgroundColor: EDColors.black, marginHorizontal: 3 }]}
              label={"Reservation"}
              textStyle={{
                color: EDColors.white,
                fontFamily: EDFonts.medium,
          ...
          <View style={{ flex: 1 }}>
            <EDButton
              ...
              onPress={() =>
                NavigationService.navigateToSpecificRoute("Vacation")
              }
            />
          </View>
        </View>
